    ...
    var popup = {
        ...
        updateImagesMarkup: function(src, title, counter) {
            ...
            var markup = '<div class="cbp-popup-lightbox-figure">' +
                '<div class="image-container"><img src="' + src + '" class="cbp-popup-lightbox-img" ' + t.dataActionImg + ' />' +
                '<div class="cbp-popup-lightbox-bottom">' +
                ((title) ? '<div class="cbp-popup-lightbox-title">' + title + '</div>' : '') +
                counter +
                '</div>' +
        ...
        resizeImage: function() {
            ...
            var height = $(window).height(),
                ...
                imgContainer = this.content.find('.image-container'),
                lightboxBottom = this.content.find('.cbp-popup-lightbox-bottom'),
                padding = parseInt(img.css('margin-top'), 10) + parseInt(img.css('margin-bottom'), 10);

            var imgWidth = img.width();

            img.css('max-height', (height - padding - 100) + 'px');
            imgContainer.css('max-width', imgWidth + 'px');
            lightboxBottom.css('max-width', imgWidth + 'px');
        },
